...
export const useTableStore = defineStore('app-table', () => {
  ...
  return {refresh,setRefresh, setEdit, editId, setLoading, isLoading, urls, setUrls, data, isDeleteDialogOpen, setData, setDeleteDialog, setDeletedItemId, deletedItemId, setFormDialog, isFormDialogOpen, createFields, setFields, setInitialData, initalData, setDialogTitle, dialogTitle }
})
